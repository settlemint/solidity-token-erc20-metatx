 ...
 */
contract GenericTokenMeta is ERC20, ERC20Burnable, ERC165, ERC2771Context, ERC20Pausable, Ownable {
    constructor(
        string memory name_,
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC165) returns (bool) {
        return interfaceId == type(IERC20).interfaceId || interfaceId == type(ERC20Burnable).interfaceId
            || interfaceId == type(ERC20Pausable).interfaceId || interfaceId == type(ERC2771Context).interfaceId
